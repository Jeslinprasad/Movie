...
function Navbar() {
    ...
    return (
        <>
            ...
            <nav className={`${activemobile ? 'block' : 'hidden'} fixed bg-red/90 md:bg-black h-full w-full md:w-[15rem] z-30 md:block`}>
                <motion.div
                    animate={{ scale: 1 }}
                    initial={{ scale: 0 }}
                ...
                >
                    <Link to="/" className="logo flex flex-col justify-center items-center m-7 gap-2" onClick={() => setActivemobile(!activemobile)}>
                        ...
                        <h1 className="text-gray-400/70 font-bold text-2xl text-center">Movies</h1>
                    </Link>
                </motion.div>
